...
1. Добавлены расовые и классовые умения Артей:
    * Древо Освобождения: Воин Артеи (Ур. 1) >>> Боец Сайхи (Ур. 40) >>> Ловец Ветра (Ур. 76) >>> Заступник Сайхи (Ур. 85)
    ...
    | Воин Артея | Превосходная Устойчивость | Макс. HP +6349, Макс. CP +481, Бонус Восстановления HP +12, Бонус Восстановления MP +6, Бонус Восстановления CP +6, Скорость +14. |
    ...
    * В таблице указаны значения на максимальных уровнях умений.
    ...
    * Древо Освобождения: Маг Артеи (Ур. 1) >>> Последователь Сайхи (Ур. 40) >>> Укротитель Ветра (Ур. 76) >>> Громовержец Сайхи (Ур. 85)
    ...
    | Маг Артея | Приручение Ветра | На 10 сек. персонаж исчезает, слившись с ветром. Скорость +100. Эффект отменяется при обычной атаке или при использовании атакующего умения. Требуется меч/дробящее оружие. |
